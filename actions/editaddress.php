...
<body>
    <div class="container-fluid">
        ...
        $addupdate = $result->fetch_assoc(); // mzsqli_fetch_assoc($result)
    }        
    ?>
    <div class="updatesections">
    	<div >
    		<h3>UPDATE ADDRESS DATA</h3>
    	</div>
    	<hr>	
    	...
    	<form class="createupdateeditingforms" id="updateaddressinfo" method="POST">
           <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input type="hidden" name="Address_ID" value="<?php echo $addupdate["Address_ID"] ?>">
            </div>
        </div>	
        <div class="row">
         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <input class="form-control" type="text" name="Street" value="<?php echo $addupdate["Street"] ?>">
        </div>
    </div>
    <div class="row">
     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <input class="form-control" type="text" name="City" value="<?php echo $addupdate["City"] ?>">
    </div>
</div>
<div class="row">
 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    <input class="form-control" type="text" name="Postcode" value="<?php echo $addupdate["Postcode"] ?>">
</div>
</div>
<div class="row">
 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    <input class="form-control" type="text" name="State" value="<?php echo $addupdate["State"] ?>">
</div>
</div>
<div class="row">
 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    <input class="form-control" type="text" name="Country" value="<?php echo $addupdate["Country"] ?>">
</div>
</div>
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <select class="form-control" id="labellettering" name="fk_User_ID">
            <option><?php echo $addupdate['fk_User_ID'] ?></option>
...
<div class="row">
 <div  id="labellettering" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <button  id="submitbtns" class="btn btn-lg btn-block" type="submit">Update Address</button>
</div>
</div>
</form>
...
if($_POST) {
    ...
    $sql = "UPDATE `addressdata` SET `Street` = '$street', `City` = '$city', `Postcode` = '$postcode', `State` = '$state', `Country` = '$country', `fk_User_ID` = '$userid' WHERE `Address_ID` = {$addressid}";
