        ...
        <main class="">
            ...
            if($_GET['Content_ID']) {
               ...
               $sql = "SELECT * FROM contentdata WHERE Content_ID = {$contentid}";
                ...
                $delcont = $result->fetch_assoc(); // mzsqli_fetch_assoc($result)
            }        
            ?>
<div class="updatesections">
	<div >
		<h3>DELETE CONTENT DATA</h3>
	</div>
	<hr>	
	...
	<form class="createupdateeditingforms" id="updatecontentinfo" method="POST">
       <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <input type="hidden" name="Content_ID" value="<?php echo $delcont["Content_ID"] ?>">
        </div>
    </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input class="form-control" type="text" name="Image" value="<?php echo $delcont["Image"] ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <select class="form-control" id="labellettering" name="Locationtype">
                    <option><?php echo $delcont['Locationtype'] ?></option>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input class="form-control" type="text" name="Locationname" value="<?php echo $delcont["Locationname"] ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <select class="form-control" id="labellettering" name="fk_Address_ID">
                    <option><?php echo $delcont["fk_Address_ID"] ?></option>
                    <option disabled="">---------------------------</option>
                    <option></option>
                    <?php 
                    require_once 'db_connect.php';
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input class="form-control" type="text" name="Telephone" value="<?php echo $delcont["Telephone"] ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input class="form-control" type="text" name="Webaddress" value="<?php echo $delcont["Webaddress"] ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input class="form-control" type="text" name="Metrostop" value="<?php echo $delcont["Metrostop"] ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input class="form-control" type="text" name="OpenTimes" value="<?php echo $delcont["OpenTimes"] ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input class="form-control" type="text" name="Value" value="<?php echo $delcont["Value"] ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input class="form-control" type="text" name="Eventplacename" value="<?php echo $delcont["Eventplacename"] ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input class="form-control" type="text" name="Entrycost" value="<?php echo $delcont["Entrycost"] ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input class="form-control" type="time" name="Eventtime" value="<?php echo $delcont["Eventtime"] ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input class="form-control" type="date" name="Eventdate" value="<?php echo $delcont["Eventdate"] ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <select class="form-control" id="labellettering" name="fk_User_ID">
                    <option><?php echo $delcont["fk_User_ID"] ?></option>
                    <option disabled="">--------------------</option>
                    <option></option>
                    <?php 
                    require_once 'db_connect.php';
        ...
        <div class="row">
            <div  id="labellettering" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <button id="submitbtns" class="btn btn-lg btn-block" type="submit">Delete Content</button>
            </div>
        </div>
    </form>
</div>
...
if($_POST) {
    ...
    $sql = "DELETE FROM `contentdata` WHERE `Content_ID` = {$contentid}";
