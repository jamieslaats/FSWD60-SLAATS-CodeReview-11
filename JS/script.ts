...
class hotspot{
	...
	telephone: string;
	date: string;
	constructor(image,name,street,city,postCode,telephone,date){
		this.image = image;
		this.name = name;
		this.street = street;
		this.city = city;
...
class sights extends hotspot {
	...
	openTimes: string;
	entryCost: string;
	constructor(img,name,street,city,postCode,telephone,date,metro,openTimes,entryCost) {
		super(img,name,street,city,postCode,telephone,date);
		this.metro = metro;
...
class eatery extends hotspot {
	...
	value: string;
	webAddress: string;
	constructor(img,name,street,city,postCode,telephone,date,type,value,webAddress){
		super(img,name,street,city,postCode,telephone,date);
		this.type = type;
		this.value = value;
...
class events extends hotspot {
	...
	eventTime: string;
	ticketPrice: number;
	constructor(img,name,street,city,postCode,telephone,date,eventPlace,eventDate,eventTime,ticketPrice){
		super(img,name,street,city,postCode,telephone,date);
